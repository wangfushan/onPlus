...
import com.example.demo.common.utils.JsonHelper;
import com.example.demo.common.utils.MapUtil;
import com.example.demo.common.utils.RequestUtil;
...
public class LogInterceptor {
    ...
    public void beforeMethod(JoinPoint joinPoint) {
        ...
        sb.append("IN  IP:").append(RequestUtil.getRemoteAddr(request)).append(",Url:").append(RequestUtil.trimURI(request))
